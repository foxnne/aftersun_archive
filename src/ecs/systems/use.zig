                    ...
                    if (entity) |use_entity| {
                        ...
                        if (use_entity.has(components.Useable)) {
                            if (use_entity.getMut(components.Toggleable)) |toggleable| {
                                ...
                                if (use_entity.get(components.ToggleAnimation)) |toggle_animation| {
                                    if (use_entity.getMut(components.SpriteAnimator)) |animator| {
                                    ...
                                    if (use_entity.getMut(components.SpriteRenderer)) |renderer| {
                                        if (toggleable.state == false) {
                                            renderer.index = toggle_animation.off_index;
                                        }
                                    }

                                    if (use_entity.getMut(components.LightRenderer)) |renderer| {
